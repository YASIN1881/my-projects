...
addNewCourseBtn.addEventListener("click", (e) => {
  ...
  let newCourseInfos = {
    ...
    body: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quam nemo natus perspiciatis maiores modi praesentium laborum, dicta culpa minima, aliquid voluptatem? Aliquid possimus eveniet ex et reiciendis eius voluptas perferendis.",
    ...
    .then((courses) => {
      ...
      courses.forEach((course) => {
        ...
        <article class="course-box">
                            <img src="${
                              course.cover
                            }" class="course-img" alt=""> <!-- course image -->
